...
public class UserInterface {
    ...
    protected static String csvPath = "OOP/Homework4/Planner.csv";
    protected static String jsonPath = "OOP/Homework4/Planner.json";
    protected static String xmlPath = "OOP/Homework4/Planner.xml";
